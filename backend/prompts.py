...
class PromptLibrary:
    ...
    def _get_fallback_template(self, filename: str) -> str:
        ...
        if filename == "sql_generation.txt":
            return (
                ...
                "User Query Request (Follow-up or Standalone): {user_question}\n\n"
                "Rules:\n"
    ...
    def format_sql_generation(self, user_question: str, semantic_context: str, db_schema: str, previous_error: str = None, few_shot_context: str = "", chat_history: str = "") -> str:
